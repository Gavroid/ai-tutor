...
>
> **Сравнение с `PROMPT-FOR-OTHER-AI.md`:** базовый промт (559 строк) — это вводная для разработки. Этот документ — расширенная версия с фокусом на **аудит и стратегические рекомендации**. Прочти оба.
>
